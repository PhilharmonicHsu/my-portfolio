  ...
  return (
    <section ref={sectionRef} className="pt-10 pb-4 sm:px-10 px-0 max-w-4xl mx-auto text-center">
      ...
      <div ref={iconsRef} className="flex justify-center gap-6 text-3xl mt-4">
        <a title="GitHub" href="https://github.com/PhilharmonicHsu" target="_blank" className="text-gray-300 hover:text-pink-400">
        ...
        <a title="Linkdin" href="https://www.linkedin.com/in/yuwei-hsu-280432327/" target="_blank" className="text-gray-300 hover:text-pink-400">
